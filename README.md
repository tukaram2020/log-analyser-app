...
A simple program to read, parse and flag the evens from a log file.
...
```shell
git clone https://github.com/tukaram2020/log-analyser-app.git
```

2. Open the project in an IDE of your choice.
3. Run the main application - `com.assignment.loganalyser.app.LogAnalyser`.
   
   Provide the input file name from Run configuration . Screenshot is available at https://github.com/tukaram2020/log-analyser-app/blob/main/screenshot/inputFileName.JPG
